                    ...
                    <!-- Right Side Of Navbar -->
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                          ...
                          @else
                          <?php
                          $user=DB::table('customers')->where('id','=',Auth::user()->id);
                          ?>
                          <li class="nav-item">
                          ...
                          <div class="dropdown">
                              <a class="nav-link dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-bell"><span class="badge badge-danger">{{ count(Auth::user()->notifications) }}</span></i>
                              </a>

                              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                @foreach(Auth::user()->notifications as $n)
                                <a class="dropdown-item border-bottom" href="#">&nbsp;{{ $n->data['not_message'] }}&nbsp;&nbsp;<i class="fa fa-check text-success"></i><br><small>{{ $n->created_at->diffForHumans() }}</small></a>
                                @endforeach
                              </div>
                            </div>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.index') }}" target="_blank"><i class="fa fa-rocket"></i> ADMIN</a>
                          </li>
                          @endif
                          <li class="nav-item">
